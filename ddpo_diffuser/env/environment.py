...
class RLDiffuser(gym.Env):
    ...
    def __init__(self, **kwargs: dict) -> None:
        ...
        if self.env_config['state_only']:
            state_dim = self.env_config['horizon'] * self.env_config['obs_dim']
        else:
            state_dim = self.env_config['horizon'] * (self.env_config['obs_dim'] + self.env_config['action_dim'])
        ...
        self._max_episode_step = self.env_config['diffusion_steps']
        self.diffuser = 0


    def rollout(self, condition):
...
class SafeRLDiffuserEnv(CMDP):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._env = RLDiffuserEnv(**kwargs)
