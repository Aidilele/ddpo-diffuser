...
class RLBuffer:
    def __init__(self, config, obs_dim, max_size=128, sample_batch_size=8):
        ...
        self.state = torch.zeros((max_size, n_diffusion_steps, horizon, obs_dim))
        self.n_state = torch.zeros((max_size, n_diffusion_steps, horizon, obs_dim))
    ...
    def store(self, state, n_state, log_prob, advantage, cond, t):
